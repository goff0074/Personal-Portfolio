 ...
 * mode: Interpret the data as integers (0) or pixels (1)
 */
typedef struct {
    int **data;
    unsigned nrows;
 ...
 * 'val': The integer representation of the value to be put into the matrix
 ...
 * You may assume that 'i' and 'j' are valid for the dimensions of 'mat'
 * Returns the integer representation of the element at row 'i' and column 'j' of 'mat'
 */
